...
if($query){
echo "<p class'success'>Expense has been added</p>";
...
<head>
	...
	<title>Daily Expense Trace || Add Expense</title>
						...
						<div class="col-md-12">
							...
							<form role="form" method="post" action="">
								...
								<div class="form-group">
									...
									<?php 
										$query=mysqli_query($con, "SELECT DISTINCT ExpenseItem FROM tblexpense ORDER BY ExpenseItem DESC");
					  					while ($row=mysqli_fetch_array($query)) {?>
										<option value="<?php  echo $row['ExpenseItem'];?>">	
